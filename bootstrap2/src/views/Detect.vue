...
export default {
  ...
  data(){
    return{
      ...
      items: [
        {isActive: true,ID:1,Cam_No:1,State:'주의',date:'2023-05-11',imageUrl:'www.naver.com',distance:'53㎡',Area:'용산구'},
...
.custom_hr{
  width: 1000px;
  height: 10px;
  background-image: linear-gradient(to right, #eee, #777, #eee);
  border: none;
  margin: 10px;
  margin-left: auto;
  margin-right: auto;
...
.searchbar{
  padding-left: 150px;
  padding-right: 150px; /* 넓이를 조절하고자 하는 크기로 변경해주세요 */
  padding-bottom: 20px;
}
</style>