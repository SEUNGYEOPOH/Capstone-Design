...
from tools.img_seg.models.unet import vgg_unet
from tools.img_seg import predict
...
def area_app(save_path):
    ## area app

    model = vgg_unet(n_classes=50 , input_height=640, input_width=640  )
    model.load_weights('./best_seg.h5')
