...
export default {
    ...
    data() {
        ...
        markers: [
            ...
            },
            {
                id: 6,
                title: "정왕동",
                coordinates: [37.351836439, 126.742808813],
            }
        ],
    ...
    methods: {
        ...
        getImageUrl(condition){
            if (condition === '안전'){
                return "https://readme-typing-svg.demolab.com?font=Fira+Code&size=40&pause=1000&color=F7F6F6&background=25C30380&center=true&vCenter=true&width=400&height=300&lines=%F0%9F%9B%A1+Safety+%F0%9F%9B%A1";
            } else if (condition === '주의'){
                return "https://readme-typing-svg.demolab.com?font=Fira+Code&size=40&duration=2500&pause=500&color=F7F6F6&background=FFAB20DF&center=true&vCenter=true&width=400&height=300&lines=%E2%9A%A0++caution+%E2%9A%A0";
            } else{
                return "https://readme-typing-svg.demolab.com?font=Fira+Code&size=40&duration=1250&pause=250&color=F7F6F6&background=FF1914B1&center=true&vCenter=true&width=400&height=300&lines=%F0%9F%9A%A8++danger+%F0%9F%9A%A8";
            }
        },    
        fetchData() {
            axios
